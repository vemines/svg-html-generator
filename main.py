...
folder_path = "D:/Code/web-assets/svgs/regular"
# Set the base output filename
file_name = "fa-regular"
# Set Icon width
icon_width = 200
# Set Icon height
icon_height = 200
...
<head>
  ...
  <style>
    ...
    .svg-preview {{ width:{icon_width}px; margin: 10px; padding: 10px; border: 1px solid #ccc; border-radius: 8px; }}
    svg {{ width: {icon_width}px; height: {icon_height}px; }}
    h3 {{ text-align: center; word-wrap: break-word; }}
